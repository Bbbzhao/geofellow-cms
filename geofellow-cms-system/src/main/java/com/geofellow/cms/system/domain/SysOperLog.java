package com.geofellow.cms.system.domain;

import com.geofellow.cms.common.annotation.Excel;
import com.geofellow.cms.common.base.BaseEntity;
...
public class SysOperLog extends BaseEntity {
    ...
    @Excel(name = "请求方法")
    @ApiModelProperty(value="请求方法",name="method",example="com.geofellow.cms.web.controller.monitor.SysUserOnlineController.forceLogout()")
